...
public class R20SemanticUtilsTest {
    static GermaNet gnet;
    static SemanticUtils semanticUtils;
    static String dataPath;

    private static final Logger LOGGER = LoggerFactory.getLogger(R20SemanticUtilsTest.class);
    ...
    void longestShortestNounTest() {
        ...
        Set<LeastCommonSubsumer> expected = Sets.newHashSet(
                ...
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(49774, 145392), 35),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(147253, 49774), 35),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(20560, 49774), 35)
        );
    ...
    void longestShortestVerbTest() {
        Set<LeastCommonSubsumer> expected = Sets.newHashSet(
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(57534, 119463), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(120154, 119463), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(172937, 106731), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(151057, 119463), 28),

                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(172221, 106731), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(123240, 106731), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(150086, 106731), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(106731, 57534), 28),

                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(106731, 178592), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(120154, 106731), 28),

                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(172937, 119463), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(151057, 106731), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(123240, 119463), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(150086, 119463), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(123246, 119463), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(106731, 123246), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(178592, 119463), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(172221, 119463), 28)
        );
    ...
    void longestShortestAdjTest() {
        ...
        Set<LeastCommonSubsumer> expected = Sets.newHashSet(
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94411, 181691), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 181691), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 181284), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95326, 181691), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 95326), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 94411), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94411, 181284), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 181691), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95326, 181675), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 181284), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 94411), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95326, 181656), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 181656), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(181656, 94411), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95987, 181675), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(181675, 94411), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 95326), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 181656), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(94396, 181675), 20),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(95326, 181284), 20)
        );
    ...
    void similarityMeasuresTest(SemRelMeasure semRelMeasure, Integer sID1, Integer sID2, int normalizedMax, Double expected) {
        ...
        double epsilon = 0.01; // tolerance for working with doubles
    ...
    private static Stream<Arguments> resnikProvider() {
        ...
        return Stream.of(
                Arguments.of(SemRelMeasure.Resnik, bambusID, veilchenID, 0, 2.52086),
                Arguments.of(SemRelMeasure.Resnik, bambusID, veilchenID, 10, 2.55906),
                ...
                Arguments.of(SemRelMeasure.Resnik, apfelbaumId, giftpflanzeId, 0, 2.52086),
                Arguments.of(SemRelMeasure.Resnik, apfelbaumId, giftpflanzeId, 10, 2.55906),
                Arguments.of(SemRelMeasure.Resnik, giftpflanzeId, apfelbaumId, 0, 2.52086),
                Arguments.of(SemRelMeasure.Resnik, giftpflanzeId, apfelbaumId, 10, 2.55906),
                Arguments.of(SemRelMeasure.Resnik, riechenID, schmeckenID, 0, 1.35137),
                Arguments.of(SemRelMeasure.Resnik, riechenID, schmeckenID, 10, 1.35644),
                Arguments.of(SemRelMeasure.Resnik, laufenID, springenID, 0, 1.530),
    ...
    private static Stream<Arguments> jiangAndConrathProvider() {
        ...
        return  Stream.of(
                Arguments.of(SemRelMeasure.JiangAndConrath, bambusID, veilchenID, 0, 14.13320),
                Arguments.of(SemRelMeasure.JiangAndConrath, bambusID, veilchenID, 10, 7.17369),
                ...
                Arguments.of(SemRelMeasure.JiangAndConrath, apfelbaumId, giftpflanzeId, 0, 14.86374),
                Arguments.of(SemRelMeasure.JiangAndConrath, apfelbaumId, giftpflanzeId, 10, 7.54450),
                Arguments.of(SemRelMeasure.JiangAndConrath, giftpflanzeId, apfelbaumId, 0, 14.86374),
                Arguments.of(SemRelMeasure.JiangAndConrath, giftpflanzeId, apfelbaumId, 10, 7.54450),
                Arguments.of(SemRelMeasure.JiangAndConrath, riechenID, schmeckenID, 0, 14.7336),
                Arguments.of(SemRelMeasure.JiangAndConrath, laufenID, springenID, 0, 15.434),
    ...
    private static Stream<Arguments> linProvider() {
        ...
        return Stream.of(
                ...
                Arguments.of(SemRelMeasure.Lin, bambusID, veilchenID, 10, 4.75188),
                ...
                Arguments.of(SemRelMeasure.Lin, apfelbaumId, giftpflanzeId, 10, 5.10326),
                Arguments.of(SemRelMeasure.Lin, giftpflanzeId, apfelbaumId, 0, 0.51933),
                Arguments.of(SemRelMeasure.Lin, giftpflanzeId, apfelbaumId, 10, 5.10326),
