...
class R18GermaNetTest {
    static GermaNet gnetCaseSensitive;
    static GermaNet gnetIgnoreCase;
    static String dataPath;
    private static final Logger LOGGER = LoggerFactory.getLogger(R18GermaNetTest.class);
    ...
    void synsetCountTest() {
        assertEquals(167163, gnetCaseSensitive.numSynsets());
        assertEquals(167163, gnetIgnoreCase.numSynsets());
    }

    @Test
    void lexUnitCountTest() {
        // one less since ROOT lex unit is not loaded
        assertEquals(215000 -1, gnetCaseSensitive.numLexUnits());
        assertEquals(215000 -1, gnetIgnoreCase.numLexUnits());
    }

    @Test
    void compoundCountTest() {
        assertEquals(124657, gnetCaseSensitive.getLexUnitsWithCompoundInfo().size());
        assertEquals(124657, gnetIgnoreCase.getLexUnitsWithCompoundInfo().size());
    }

    @Test
    void iliCountTest() {
        // release 17
        assertEquals(28563, gnetCaseSensitive.getIliRecords().size());
        assertEquals(28563, gnetIgnoreCase.getIliRecords().size());
    }
