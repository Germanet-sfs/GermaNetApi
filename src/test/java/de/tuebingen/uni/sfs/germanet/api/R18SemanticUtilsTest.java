...
public class R18SemanticUtilsTest {
    static GermaNet gnet;
    static SemanticUtils semanticUtils;
    static String dataPath;

    private static final Logger LOGGER = LoggerFactory.getLogger(R18SemanticUtilsTest.class);
    ...
    void longestShortestVerbTest() {
        Set<LeastCommonSubsumer> expected = Sets.newHashSet(
                ...
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(aufstuelpenID, anmusternID), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(aufstuelpenID, verlautenID), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(hochrutschenID, verlautenID), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(aufschleudernID, anmusternID), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(aufschleudernID, verlautenID), 28),
                
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(einstaeubenID, anmusternID), 28),
                new LeastCommonSubsumer(GNROOT_ID, Sets.newHashSet(einstaeubenID, verlautenID), 28)
        );
