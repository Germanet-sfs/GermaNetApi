...
/**
 * A <code>Compound</code> shows constituent parts of a German word, their
...
public class Compound {
    ...
    /**
     * Constructs a <code>Compound</code> with the specified attributes.
     * @param modProp
     * @param modifier1
     * @param mod1Cat
     * @param modifier2
     ...
     * @param headProp
     */
    public Compound (CompoundProperty modProp, String modifier1,
    ...
    /**
     * Returns the first modifier of this <code>Compound</code>
     * @return the first modifier of this <code>Compound</code>
     */
    ...
    /**
     * Returns the second modifier of this <code>Compound</code>
     * or null if it has not been set
     * @return the second modifier of this <code>Compound</code>
     */
    ...
    /**
     * Returns the head of this <code>Compound</code>
     * @return the head of this <code>Compound</code>
     */
